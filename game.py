...
pygame.display.set_caption('PY Game presented by Group 106')

icon = pygame.image.load("Q2-pygame/ic.jpg")
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("PY game presented by Group 106", wheat, 280)
